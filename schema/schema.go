...
type SiteConfiguration struct {
	...
	// CodyPermissions description: Whether to enable the new Cody RBAC-based permissions system. The deprecated cody.restrictUsersFeatureFlag is always respected first.
	CodyPermissions *bool `json:"cody.permissions,omitempty"`
	// CodyRestrictUsersFeatureFlag description: DEPRECATED. See docs instead. DESCRIPTION: Cody to only be enabled for users that have a feature flag labeled "cody" set to true. You must create a feature flag with this ID after enabling this setting: https://docs.sourcegraph.com/dev/how-to/use_feature_flags#create-a-feature-flag. This setting only has an effect if cody.enabled is true.
